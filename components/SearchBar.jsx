...
function SearchBar({ words }) {
  ...
  const [showText, setShowText] = useState([
    ...
    "Если в выпадающем списке такого нет, то данное определение отсутствует в нашем словаре.",
  ]);
  ...
  return (
    <form className='m-w-[440px] relative'>
      ...
      <div className='mt-8'>
        {/* <p className='mt-2 whitespace-pre-line'>{showText}</p> */}
